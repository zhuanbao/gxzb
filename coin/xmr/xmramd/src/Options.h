...
private:
	...
	//自定义参数
	int m_shareintensity;
	int m_shareworksize;
	int m_sharesleep;
public:
	inline int shareIntensity() const { return m_shareintensity; }
	inline int shareWorksize() const { return m_shareworksize; }
	inline int shareSleep() const { return m_sharesleep; }
};
