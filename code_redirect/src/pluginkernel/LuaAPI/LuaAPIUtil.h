...
public:
	...
	static int GetProcessExitCode(lua_State* pLuaState);
	...
	static int CloseLuaMsgWnd(lua_State* pLuaState);
	...
	static int GetProcessSnapshot(lua_State *pLuaState);
	static int InjectDllToProc(lua_State *pLuaState);
	static int RestartSystem(lua_State *pLuaState);
private:
