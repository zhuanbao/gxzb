...
const char* NetMessageDetail::name() { return EthYellow "?" EthGray " ¡ð"; }
const char* NetTriviaSummary::name() { return EthYellow "?" EthGray " ¡ò"; }
const char* NetTriviaDetail::name() { return EthYellow "?" EthCoal " ?"; }
const char* NetAllDetail::name() { return EthYellow "?" EthCoal " ¡ñ"; }
